...
import plotter
from models_util import DEVICE, GANModel
...
data_loader = DataLoader(keys_position_tanh_dataset, batch_size=batch_size, shuffle=True)
...
gan_model = GANModel(D, G, "cgan_dp_keys_tanh.pt")
